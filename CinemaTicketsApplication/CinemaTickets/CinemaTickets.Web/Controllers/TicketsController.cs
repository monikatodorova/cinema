...
namespace CinemaTickets.Controllers
{
    public class TicketsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Create([Bind("Id,Date,TicketImage,TicketDescription,Price")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("Id,Date,TicketImage,TicketDescription,Price")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
